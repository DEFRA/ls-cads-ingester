using LsCadsIngester.Example.Endpoints;
using LsCadsIngester.Example.Services;
using LsCadsIngester.Utils;
using LsCadsIngester.Utils.Http;
using LsCadsIngester.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsCadsIngester.Config;
using LsCadsIngester.Utils.Logging;
using Serilog;
