...
using Cads.Ingester.Tests.Integration.Consumers.Contracts;
using Cads.Ingester.Tests.Integration.Consumers.Helpers;
using Cads.Ingester.Tests.Integration.Helpers;

namespace Cads.Ingester.Tests.Integration.Consumers;
...
public class QueueConsumerTests(IntegrationTestFixture fixture) : IClassFixture<IntegrationTestFixture>
{
    ...
    {
        var topic = new Topic { TopicArn = "arn:aws:sns:eu-west-2:000000000000:ls-cads-cts-events" };
