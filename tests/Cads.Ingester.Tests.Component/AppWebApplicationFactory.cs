...
using Cads.Ingester.Tests.Component.Consumers.Helpers;
using Cads.Core.Messaging.Contracts;
using Cads.Core.Messaging.Observers;
...
public class AppWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public readonly Mock<HttpMessageHandler> CadsApiClientHttpMessageHandlerMock = new();
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddHttpClient("CadsApi")
                .ConfigurePrimaryHttpMessageHandler(() => CadsApiClientHttpMessageHandlerMock.Object);
    ...
    private static void SetTestEnvironmentVariables()
    {
        ...
        Environment.SetEnvironmentVariable("ApiClients__CadsApi__HealthcheckEnabled", "true");
        Environment.SetEnvironmentVariable("ApiClients__CadsApi__BaseUrl", TestConstants.CadsApiBaseUrl);
    }
